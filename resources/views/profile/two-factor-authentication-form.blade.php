            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @else
                        ...
                        <form action="{{ url('user/two-factor-recovery-codes') }}" method="POST" id="regenerate_two_factor_auth" style="display: none">@csrf</form>
                        <form action="{{ url('user/two-factor-authentication') }}" method="POST" id="delete_two_factor_auth" style="display: none">
                            @csrf
                            @method('DELETE')
                        </form>
                    @endif
